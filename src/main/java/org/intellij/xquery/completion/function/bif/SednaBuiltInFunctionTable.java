...
import org.intellij.xquery.reference.namespace.sedna.SednaPredeclaredNamespaces;

public class SednaBuiltInFunctionTable extends AbstractBuiltInFunctionTable {
    private PredeclaredNamespaces predeclaredNamespaces = new SednaPredeclaredNamespaces();

    {
        ...
        fnMap.putValue(ns("fn"), bif("fn",  "index-scan", 3, "$title as xs:string, $value as xdt:anyAtomicType, $mode as xs:string", "node()*"));
        fnMap.putValue(ns("fn"), bif("fn",  "index-scan-between", 4, "$title as xs:string, $value1 as xdt:anyAtomicType, $value2 as xdt:anyAtomicType, $range as xs:string", "node()*"));
        fnMap.putValue(ns("fn"), bif("fn",  "ftindex-scan", 3, "$title as xs:string, $query as xs:string, $options as xs:string", "node()*"));
        fnMap.putValue(ns("fn"), bif("fn",  "ftscan", 4, "$seq as node()*, $query as xs:string, $type as xs:string, $customization_rules as xs:string", "node()*"));
        ...
        fnMap.putValue(ns("sql"), bif("sql", "close", 1, "$connection as xs:integer", "element()?"));
        fnMap.putValue(ns("sql"), bif("sql", "commit", 1, "$connection as xs:integer", "element()?"));
        fnMap.putValue(ns("sql"), bif("sql", "connect", 1, "$db-url as xs:string", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "connect", 2, "$db-url as xs:string, $user as xs:string", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "connect", 3, "$db-url as xs:string, $user as xs:string, $password as xs:string", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "connect", 4, "$db-url as xs:string, $user as xs:string, $password as xs:string, $options as element()*", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "execute", 2, "$connection as xs:integer, $statement as xs:string", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "execute", 3, "$connection as xs:integer, $statement as xs:string, $query-options as element()*", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 2, "$connection as xs:integer, $statement as xs:string", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 3, "$connection as xs:integer, $statement as xs:string, $query-options as element()*", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 2, "$prepared-statement as xs:integer, $param1 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 3, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 4, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 5, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 6, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 7, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 8, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 9, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 10, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?, $param9 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 11, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?, $param9 as item()?, $param10 as item()?", "element()*"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 2, "$prepared-statement as xs:integer, $param1 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 3, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 4, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 5, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 6, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 7, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 8, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 9, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 10, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?, $param9 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "exec-update", 11, "$prepared-statement as xs:integer, $param1 as item()?, $param2 as item()?, $param3 as item()?, $param4 as item()?, $param5 as item()?, $param6 as item()?, $param7 as item()?, $param8 as item()?, $param9 as item()?, $param10 as item()?", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "prepare", 2, "$connection as xs:integer, $statement as xs:string", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "prepare", 3, "$connection as xs:integer, $statement as xs:string, $query-options as element()*", "xs:integer"));
        fnMap.putValue(ns("sql"), bif("sql", "rollback", 1, "$connection as xs:integer", "element()?"));
        fnMap.putValue(ns("se"), bif("se", "get-property", 1, "$name as xs:string", "item()"));
