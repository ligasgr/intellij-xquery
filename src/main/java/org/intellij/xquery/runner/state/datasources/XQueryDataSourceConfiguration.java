...
public class XQueryDataSourceConfiguration implements Cloneable {
  ...
  @Attribute("jarLocation")
  public String JAR_LOCATION;
  ...
  public boolean equals(Object o) {
    ...
    if (JAR_LOCATION != null ? !JAR_LOCATION.equals(that.JAR_LOCATION) : that.JAR_LOCATION != null) return false;
  ...
  public int hashCode() {
    ...
    result = 31 * result + (JAR_LOCATION != null ? JAR_LOCATION.hashCode() : 0);
