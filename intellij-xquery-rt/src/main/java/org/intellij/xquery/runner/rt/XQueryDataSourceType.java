...
public enum XQueryDataSourceType {
    MARKLOGIC_NATIVE("MarkLogic (XCC)", false, true, asList("marklogic-xcc-9.0.1.jar", "groovy-all-2\\..+\\.jar", "slf4j-log4j12-.+\\.jar", "log4j-.+\\.jar"), MarklogicRunnerAppFactory.class, true, true),
    MARKLOGIC("MarkLogic (XQJ)", false, true, asList("marklogic-xqj-1.0.0.jar", "groovy-all-2\\..+.jar", "slf4j-log4j12-.+\\.jar", "log4j-.+\\.jar"), false, MarklogicXQDataSourceFactory.class),
