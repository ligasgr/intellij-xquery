...
public class XQueryTumblingWindowClauseImpl extends XQueryElementImpl implements XQueryTumblingWindowClause {

  public XQueryTumblingWindowClauseImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof XQueryVisitor) ((XQueryVisitor)visitor).visitTumblingWindowClause(this);
